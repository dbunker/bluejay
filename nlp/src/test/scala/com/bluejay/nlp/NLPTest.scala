...
import com.bluejay.nlp.NLPProcess._
...
class NLPTest extends FlatSpec {
  ...
  it should "tag tokens in text" in {
    ...
    val sentence =
      "The large and very purple sports car is somewhat red and also not green. The plump singing duck was hungry."

    val (tokenData, lemmaData, tagData, entData) = tagTokens(sentence)

    tokenData should equal(
      "The large and very purple sports car is somewhat red and also not green . The plump singing duck was hungry .")
    lemmaData should equal(
      "the large and very purple sport car be somewhat red and also not green . the plump singing duck be hungry .")
